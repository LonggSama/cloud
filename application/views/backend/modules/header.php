<header class="main-header">
    <a href="<?php echo base_url()?>admin" class="logo">
        ...
        <span class="logo-lg">System management</span>
    </a>
                ...
                <li class="dropdown user user-menu" style="height: 52px; padding: 0px">
                    ...
                    <ul class="dropdown-menu">
                        ...
                        <li class="user-footer">
                            <div class="pull-left">
                                <a href="<?php echo base_url()?>admin/useradmin/update/<?php echo $user['id'] ?>" class="btn btn-default btn-flat">Detail</a>
                            </div>
                            <div class="pull-right">
                                <a href="admin/user/logout.html" class="btn btn-default btn-flat">Exit</a>
                            </div>
                        </li>
                    </ul>
                </li>
