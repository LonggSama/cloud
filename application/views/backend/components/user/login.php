<html lang="">
    ...
    <body>
        <div class="container khung">
            <div class="title">
                <h2 class="text-center" style="color:#8ac400">AppPhakeStore.vn</h2>
            </div>
            <hr>
            <div class="myform">
                <form name="form1" action="admin/user/login.html" method="post" role="form">
                    ...
                    <div class="row form-row" style="width:100%; margin-top: 15px;">
                        <button type="submit" class="form-control btn btn-primary btn-login">Log-in</button>
                    </div>
                    <?php  if(isset($error)):?>
                        <div class="row">
        ...
        <nav class="navbar navbar-fixed-bottom" role="navigation">
            <div class="container">
               <h5 class="text-center">Copyright © 2020 <a href="https://www.facebook.com/trungphatit" style="color:red">Long</a>. All rights reserved.</h5>
            </div>
        </nav>
        <!-- jQuery -->
