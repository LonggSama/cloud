<div class="content-wrapper">
	<section class="content-header">
		<h1><i class="glyphicon glyphicon-cd"></i> List of accounts</h1>
				...
				if($user['role']==1){
					$cpnAdd.="
						<a class='btn btn-primary btn-sm' href='".base_url()."admin/useradmin/insert' role='button'>
							<span class='fa fa-user-plus'></span> Add new
						</a>";
				}
				echo $cpnAdd;
			?>
			<a class="btn btn-primary btn-sm" href="admin/useradmin/recyclebin" role="button">
				<span class="glyphicon glyphicon-trash"></span> Trash can (<?php $total=$this->Muser->user_trash_count(); echo $total; ?>)
			</a>
		</div>
	</section>
	<!-- Main content -->
								...
								<table class="table table-hover table-bordered">
									<thead>
										<tr>
											...
											<th class="text-center" style="width:50px">Repair</th>
												...
												if($user['role']==1){
													...
													$cpnAll.='
														<td class="text-center" colspan="2">
															<p class="fa fa-lock" style="color:red"> Cannot be manipulated</p>
														</td>';
												}
												echo $cpnAll;
											?>
