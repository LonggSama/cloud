    ...
    <div class="services">
        <div class="container">
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                ...
                <div class="text-img">
                    <h4 class="pull-left clear-fix">Free shipping</h4>
                    <p>For orders over 1,000,000 VND</p>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                ...
                <div class="text-img">
                    <h4 class="pull-left">20% discount</h4>
                    <p>For orders over 2,000,000 VND</p>
                </div>
            </div>
            <div class="col-xs-12 cp;-sm-12 col-md-4 col-lg-4 item">
                <div class="img-service">
                ...
                <div class="text-img">
                    <h4 class="pull-left">24/7 support</h4>
                    <p>Call right away if you need assistance</p>
                </div>
            </div>
        </div>
    </div>
            ...
            if(count($subCategory) && (count($listProducts) >= 6)):?>
                <div class="list-product">
                    ...
                    <div class="footer-load-more">
                        <a href="san-pham/<?php echo $rowCategory['link'] ?>"><p class="text-center">See more</p></a>
                    </div>
                </div>
            <?php endif;?>
        <?php endforeach;?>
                    ...
                    <div class="post-grid clearfix">
                        ...
                        <div class="entry-content width50 pull-left padding-10">
                            ...
                            <div class="entry-desc">
                                ...
                                <a href="tin-tuc/<?php echo $rowPost['alias'] ?>" class="read-more">Read more →</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<section id="demos">
    <div class="container">
        <div class="brands">
            <div class="col-md-3">
                <h2>Brand</h2>
                <p class="desc">We choose to associate the famous labels with high durability.</p>
            </div>
            <div class="col-md-9">
