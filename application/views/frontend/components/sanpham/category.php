            ...
            <div class="col-xs-12 col-sm-12 col-md-9 col-lg-9 product-content">
               <div class="product-wrap">
					...
					<div id="sort-by" class="hidden-xs">
                        <label class="left hidden-xs" for="sort-select">Sorted by: </label>
                        ...
                        <?php 
                            ...
                            if($this->session->userdata('sortby')){
                                ...
                                if($sort == 'price-asc'){
                                    $html_list.='<option value="price-asc" selected>Price increases gradually</option>';
                                }else{
                                    $html_list.='<option value="price-asc">Price increases gradually</option>';
                                }
                                if($sort == 'price-desc'){
                                    $html_list.='<option value="price-desc" selected>Price decreased gradually</option>';
                                }else{
                                    $html_list.='<option value="price-desc">Price decreased gradually</option>';
                                }
                                ...
                                if($sort == 'created-asc'){
                                    $html_list.='<option value="created-asc" selected>Oldest products</option>';
                                }else{
                                    $html_list.='<option value="created-asc">Oldest products</option>';
                                }
                            }else{
                                $html_list.='<option value="number_buy-desc">Bestseller</option>';
                                $html_list.='<option value="name-asc">A → Z</option>';
                                ...
                                $html_list.='<option value="price-desc">Price decreased gradually</option>';
                                $html_list.='<option value="created-desc">Latest products</option>';
                                $html_list.='<option value="created-desc">Oldest products</option>';
                            }
                            $html_list.='</select>';
                            echo $html_list;
                        ?>
					...
					<div class="collection-filter" id = "list-product">
						<div class="category-products clearfix">
                            ...
                            <?php if(count($list)==0): ?>
                                <p class="no-products"> List currently no products!</p>
                            <?php else : ?>
