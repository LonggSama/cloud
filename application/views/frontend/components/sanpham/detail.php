			...
			<form action="" method="post" id="ProductDetailsForm">
				<?php if($row):?>
					...
					<div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">
						<div class="product-view-content">
							...
							<div class="product-status">
								<p style=" float: left;margin-right: 10px;">Brand: <?php $name=$this->Mcategory->category_name($row['catid']); echo $name; ?></p>
								<p>| Status: <?php if($row['number']==0) echo 'Out of stock'; else echo 'Stocking' ?></p>
							</div>
					...
					<div class="product-comment product-v-desc product-">
						<h3>Products of the same type</h3>
						<?php 
                        ...
                        <?php else: ?>
                        	<p>No products of the same type or less than 6!</p>
                        <?php endif; ?>
					</div>
				<?php endif; ?>	
			</form>
