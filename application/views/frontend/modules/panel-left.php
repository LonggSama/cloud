        ...
        <div class="col-xs-12 col-sm-12 col-md-3 col-lg-3 panel-left">
            ...
            <nav class="navbar navbar-default hidden-md hidden-lg" role="navigation">
                <div class="container-fluid">
                    <div class="navbar-header">
                        ...
                        <a class="navbar-brand primary-color" href="#">Product portfolio</a>
                    </div>
            ...
            <div class="panel-left-md-768">
                <div class="header-768">
                    ...
                    <h4 class="primary-color">Product portfolio</h4>
                </div>
            </div>
        </div>
        <div class="col-md-9 col-lg-9 panel-right">
            <ul class="menu-right pull-right">
                <li class="pull-left"><a href="">Home Page</a></li>
                <li class="pull-left"><a href="san-pham">Products</a></li>
                <li class="pull-left"><a href="tin-tuc/1">News</a></li>
                <li class="pull-left"><a href="gioi-thieu">Introduce</a></li>
                <li class="pull-left"><a href="lien-he">Contact</a></li>
            </ul>
        </div>
    </div>
</div>